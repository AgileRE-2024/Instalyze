    ...
    public function headlineanalyze(Request $request)
    {
        ...
        $response = $client->post('https://chatgpt-42.p.rapidapi.com/gpt4', [
            'headers' => [
                ...
                'x-rapidapi-key' => '275bdb90d7msh05b4d9b680fa40bp1868f1jsn25ede6bab7ae',
            ],
            'json' => [
                'messages' => [
                    [
        ...
        $responseRecommendations = $client->post('https://chatgpt-42.p.rapidapi.com/gpt4', [
            'headers' => [
                'Content-Type' => 'application/json',
                'x-rapidapi-host' => 'chatgpt-42.p.rapidapi.com',
                'x-rapidapi-key' => '275bdb90d7msh05b4d9b680fa40bp1868f1jsn25ede6bab7ae',  // Ganti dengan key Anda
            ],
            'json' => [
                'messages' => [
                    [
        ...
        $wordResponse = $client->post('https://chatgpt-42.p.rapidapi.com/gpt4', [
            'headers' => [
                'Content-Type' => 'application/json',
                'x-rapidapi-host' => 'chatgpt-42.p.rapidapi.com',
                'x-rapidapi-key' => '275bdb90d7msh05b4d9b680fa40bp1868f1jsn25ede6bab7ae', // Ganti dengan API key Anda
            ],
            'json' => [
                'messages' => [
                    [
